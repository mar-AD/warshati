...
<div className="flex flex-col xl:flex-row items-stretch justify-between xl:gap-x-20 gap-x-10 xl:gap-y-0 gap-y-10 px-8">
    <div className="w-full xl:w-1/2 text-center xl:text-left flex flex-col justify-between">
        <div className="lg:mt-10">
            ...
            >
                <span className="relative inline-block">
                    ...
                    src={green_cercle}
                    alt=""
                    className="absolute top-[5px] left-[-8px] w-[3rem] sm:w-[3rem] md:w-[4rem] lg:w-[5rem]  pointer-events-none select-none -z-10"
                    />
                    W
                </span>
