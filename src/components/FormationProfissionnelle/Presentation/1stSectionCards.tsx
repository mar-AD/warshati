...
const FirstSectionCards = () => {
    const t = useTranslations("formationProfessionnelle.presentation")
    return (
        <motion.div
        variants={FadeUp(.6)}
        initial="initial"
        whileInView="animate"
        viewport={{ once: true }}
        className="bg-violet-900 py-10 px-6 sm:py-12 sm:px-12 md:py-14 md:px-16 lg:py-16 lg:px-20 xl:px-28 rounded-2xl mt-10 sm:mt-12 md:mt-16">
            <motion.div
            variants={FadeUp(.8)}
            initial="initial"
            whileInView="animate"
