...
const WorkShopCard: React.FC<ageType> = ({ ageRange, description, image,delay }) => {
  return (
    <motion.div
      variants={FadeRight(delay)}
      initial="initial"
      whileInView="animate"
      viewport={{ once: true }} className="border rounded-xl px-2 py-8 hover:bg-violet-800 group font-Poppins transition-colors flex flex-col items-center gap-4 duration-300 relative">
