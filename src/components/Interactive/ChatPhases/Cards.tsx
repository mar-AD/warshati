    ...
    >
      ...
      <div
        className={cn(
          ...
          "w-full lg:w-[30rem] md:w-[26rem] sm:w-[22rem] xs:w-[18rem]",
      ...
      >
        ...
        <div className="flex flex-col items-center gap-2 font-bold w-40 lg:w-80 md:w-72 sm:w-60">
          <Image className="lg:w-20 md:w-20 sm:w-16 w-14" src={cardData.icon} alt="Card Icon" />
        </div>
