  ...
  return (
    <div className="relative p-8 flex flex-col items-center justify-center min-h-screen overflow-hidden max-md:mt-10 ">
      ...
      <Image
        src={flight}
        alt=""
        className="absolute left-0 w-[8rem] sm:w-[8rem] md:w-[10rem] lg:w-auto md:top-52 max-md:top-52 lg:top-auto z-[-1] transition-all duration-500 ease-in-out"
      />
      ...
      <Image
        ...
        ${
          overflowVisible
            ? "-top-32 -left-56 w-[18rem] h-[23rem] sm:w-[22rem] sm:h-[27rem] md:w-[25rem] md:h-[30rem]"
            : [1, 2, 3, 4, 5, 7].includes(screenIndex)
            ? "-top-32 -left-56 w-[18rem] h-[23rem] sm:w-[22rem] sm:h-[27rem] md:w-[25rem] md:h-[30rem]"
      ...
      <Image
        ...
        ${
          overflowVisible
            ? "right-56 -bottom-60 w-[12rem] h-[18rem]"
            : [1, 2, 3, 4, 5, 7].includes(screenIndex)
            ? "-right-72 bottom-0"
            : "right-56 -bottom-60"
        } 
      ...
      <Image
        src={circle}
        alt=""
        className={`absolute -left-20 -bottom-60 w-[25rem] h-[30rem] sm:w-[28rem] sm:h-[35rem] md:w-[35rem] md:h-[41rem] z-[-1] 
        ${
          overflowVisible
            ? "block"
            : [1, 2, 3, 4, 5, 7].includes(screenIndex)
      ...
      {screenIndex === 7 && (
        <>
          <Image
            src={circle}
            alt=""
            className="absolute -left-16 -bottom-48 lg:w-[30rem] lg:h-[35rem] sm:w-[22rem] sm:h-[26rem] md:w-[25rem] md:h-[30rem] z-[-1]"
          />

          <Image
            src={circle}
            alt=""
            className="absolute left-1/2 -translate-x-1/2 -bottom-80 w-[20rem] h-[24rem] sm:w-[24rem] sm:h-[28rem] md:w-[28rem] md:h-[32rem] z-[-1]"
          />
        </>
      )}
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center w-full mx-auto lg:h-[80vh] lg:mt-0">
        ...
        >
          ...
          <Image
            src={warchati}
            alt="Warchati"
            className="absolute top-[70%] left-[50%] transform -translate-x-1/2 -translate-y-1/2 w-[4rem] md:w-[3rem] sm:w-[2rem] max-sm:w-[2rem] transition-all duration-500 ease-in-out"
          />
        </motion.div>
        ...
        <motion.div
          ...
          exit="initial"
          className={`w-full ${
            showLeft ? "lg:w-[500px]" : "lg:w-[800px]"
          } text-center order-3 lg:order-3 
          ${
            screenIndex === 1
              ? "md:h-[85%] lg:h-[95%]"
              : screenIndex === 7
              ? "md:h-[40%] lg:h-[40%] !lg:mt-0"
              : "md:h-[85%] lg:h-[85%]"
          }
          max-sm:max-h-[700px]
          
          lg:mt-[10vh]  ${
            overflowVisible ? "lg:overflow-visible" : " lg:overflow-y-auto"
          }  scrollbar-hidden
        `}
        >
          {screenIndex === 1 && (
