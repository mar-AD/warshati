  ...
  const t = useTranslations();  // Hook for translations
    ...
    return (
        ...
        <div className="flex items-start md:justify-between justify-start flex-wrap md:gap-16 gap-y-8">
            ...
            whileInView="animate"
            viewport={{ once: true }}
            className="max-w-80 text-slate-200"
            >
            ...
            className="space-y-5"
            >
            <h1 className="font-semibold capitalize">{t('footer.quick_links')}</h1>
            ...
            className="space-y-5"
            >
            <h1 className="font-semibold capitalize">{t('footer.contact_us')}</h1>
            ...
            whileInView="animate"
            viewport={{ once: true }}
            className="space-y-5 bg-black/50 h-fit p-5 rounded-xl"
            >
            <h1 className="font-semibold capitalize">{t('footer.newsletter')}</h1>
            <div className="flex flex-wrap gap-4">
                <input
                className="bg-transparent placeholder:text-xs outline-none"
                type="text"
                placeholder={t('footer.email_placeholder')}
                />
                <button className="bg-slate-950 p-2 rounded-lg">{t('footer.subscribe')}</button>
            </div>
            <p className="text-xs text-slate-400 max-w-96">
        ...
        <motion.div
            ...
            whileInView="animate"
            viewport={{ once: true }}
            className="place-self-end col-span-5 space-y-6"
        >
            <p className="text-slate-400">
            <span>&copy;</span> {t('footer.footer_text', { year: new Date().getFullYear() })}
            </p>
